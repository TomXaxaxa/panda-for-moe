...
checkpoint_dir="./checkpoints/panda256+encoder+FlashAttention/checkpoint-final"
...
python scripts/patchtst/evaluate.py \
    ...
    eval.metrics_save_dir=./eval_results/patchtst/panda256+FlashAttention/test_example \
